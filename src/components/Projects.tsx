...
const projects = [
  {
    ...
    description: "기업 내부망·DMZ·외부망 구조를 직접 설계하고 VPN, 방화벽, IDS/HIDS, 모니터링을 통합 구성한 보안 인프라 구축 프로젝트입니다. 실제 공격 시나리오를 통해 탐지·분석 과정을 구현하며 기업형 보안 운영 환경을 재현했습니다.실제 공격 시나리오를 통해 탐지·분석 과정을 구현하며 기업형 보안 운영 환경을 재현했습니다.",
    icon: Shield,
